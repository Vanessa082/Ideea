...
// import { Board, CanvasElement } from '../../types/board.types';
// import { useAuth } from '@/core/hook/authContext';
...
//   return (
//     <div
//       className={`bg-white rounded-lg border p-4 hover:shadow-lg transition-all cursor-pointer relative group ${isActive ? 'ring-2 ring-blue-500 shadow-md' : ''
//         }`}
//       onClick={onOpen}
